...
class AddCalculation(ttk.Frame):
    def __init__(self, container, controller):
        ...
        first_label = ttk.Label(self, textvariable=self.a_value, style="MyLabel.TLabel")
        operator_label = ttk.Label(self, text="ADD", style="MyLabel.TLabel")
        second_label = ttk.Label(self, textvariable=self.b_value, style="MyLabel.TLabel")
        answer_input = ttk.Entry(self, width=10, textvariable=self.answer_value)
...
class Substract(ttk.Frame):
    def __init__(self, container, controller):
        ...
        self.answer_value = tk.IntVar()
        first_label = ttk.Label(self, textvariable=self.a_value, style="MyLabel.TLabel")
        operator_label = ttk.Label(self, text="MINUS", style="MyLabel.TLabel")
        second_label = ttk.Label(self, textvariable=self.b_value, style="MyLabel.TLabel")
        answer_input = ttk.Entry(self, width=10, textvariable=self.answer_value)
        first_label.grid(column=0, row=0, sticky="E")
        operator_label.grid(column=1, row=0, sticky="E")
